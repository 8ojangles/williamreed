                    ...
                    {filteredItems && (
                        <> 
                            <TabContentItem
                                ...
                                dataValue={"1-50"}
                            >
                                {sortedItems.top50.map((pub, index) => (
                                    <Card key={pub.id} pub={pub} introDelay={index*100} scrollPosition={scrollPosition} />
                                ))}  
                            </TabContentItem>
                            <TabContentItem
                                key={`tab-content-2`}
                                ...
                                dataValue={"51-100"}
                            >
                                {sortedItems.top100.map((pub, index) => (
                                    <Card key={pub.id} pub={pub}  introDelay={index*100} scrollPosition={scrollPosition} />
                                ))}
                            </TabContentItem>
                            <TabContentItem
                                ...
                                addClass="awards"
                            >
                                {sortedItems.specialistAwards.map((pub, index) => (
                                    <Card key={pub.id} pub={pub} showRanking={false} showInfo={true} introDelay={index*100} scrollPosition={scrollPosition} />
                                ))}
                            </TabContentItem>
                        </>
                    )}
